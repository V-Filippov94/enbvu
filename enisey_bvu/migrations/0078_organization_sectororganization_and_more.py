...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('enisey_bvu', '0077_alter_content_content'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '3. Организация ("Структура управления")',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AlterModelOptions(
            name='listfile',
            options={'verbose_name': 'Файл', 'verbose_name_plural': 'Добавить список файлов'},
        ),
        ...
        migrations.AlterField(
            model_name='file',
            name='list_file',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='enisey_bvu.listfile', verbose_name='Пояснение к файлу'),
        ),
        migrations.CreateModel(
            name='Worker',
            fields=[
            ...
            options={
                ...
                'verbose_name_plural': '3.1 Сотрудники ("Структура управления")',
            },
        ),
        migrations.CreateModel(
            name='PhoneWorker',
