...
class NewsFilePDFInline(admin.TabularInline):
    model = NewsFilePDF


class NewsFilesInline(admin.TabularInline):
    model = NewsFiles


class NewsAdmin(admin.ModelAdmin):
    form = NewsAdminForm
    inlines = [NewsImageInline, NewsFilePDFInline, NewsFilesInline]
    list_display = ('title', 'date_create', 'time_update')
    list_display_links = ('title', )
    search_fields = ('title', 'date_create', 'time_update')
    list_filter = ('date_create', 'time_update')
    fields = ('title', 'description', 'date_create', 'time_update')
