...
class NewsFilePDF(models.Model):
    pdf = models.FileField(upload_to='index_enbvu/news/files_pdf/', blank=True, verbose_name='Файл PDF ')
    news_pdf = models.ForeignKey('News', on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        verbose_name_plural = 'Добавить Файл PDF (Значок "PDF")'


class NewsFiles(models.Model):
    file = models.FileField(upload_to='index_enbvu/news/files/', blank=True, verbose_name='Файл ("Желтая папка")')
    news_file = models.ForeignKey('News', on_delete=models.CASCADE)
    ...
    class Meta:
        verbose_name = 'Файл'
        verbose_name_plural = 'Добавить Файл PDF (Значок "Папка")'
...
class PhotoLink(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '4. Ссылки на внешний ресурс'
...
class VeteranList(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '5. Бессмертный полк'
...
class MirVodyYear(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '6. Мир воды'
